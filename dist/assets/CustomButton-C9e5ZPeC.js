import{F as s,k as e}from"./index-DnNoBgXv.js";const d=s(e.jsx("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z"}),"Add"),h=({onClick:r,children:o,className:t="",type:a="button",disabled:f=!1})=>{const n=`group relative h-16 w-64 rounded-lg border bg-sky-800 p-3 text-left text-base font-bold text-gray-50 overflow-hidden
    ...
    ${t}`;return e.jsx("button",{type:a,onClick:r,disabled:f,className:n,children:e.jsx("div",{className:"flex items-center justify-start",children:o})})};export{d as A,h as C};
